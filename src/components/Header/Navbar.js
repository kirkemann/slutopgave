            ...
            <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-light mb-3">
                ...
                <div className="collapse navbar-collapse" id="navbarNav1">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/">DYKKERUDSTYR</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/">DYKKERREJSER</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/">DYKKERKURSER</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/">KONTAKT OS</NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink className="nav-link" to="/">OM OS</NavLink>
                        </li>
                    </ul>
                    <div className="form-inline form-inline-sm ml-auto">
